...
var players = [[7, "Ema", red, lightRed, blue], [1, "Terka", green, lightGreen, brown], [49, "Tomáš", green, lightGreen, brown], [50, "Kika", green, lightGreen, brown], [2, "Lukáš", green, lightGreen, brown], [38, "Matěj", green, lightGreen, brown], [1, "Jakub", green, lightGreen, brown], [15, "Michal", green, lightGreen, brown], [48, "Anna", green, lightGreen, brown], [45, "Víťa", green, lightGreen, brown], [12, "Kryštof", green, lightGreen, brown], [20, "Bea", green, lightGreen, brown], [34, "Aďa", green, lightGreen, brown]]
...
for (var s in sameScore) {
  sameScoreInt = parseInt(sameScore[s], 10)
}

for (var p in players) {
  if(players[p][0]==JSON.stringify(sameScore))
...
for(let set = 0 ; set <= players.length; set++) {
  ...
  //move nickname to prevent overlaping
  if (players[set][0] >= 30 && players[set][0] < 49) {
    playerText[set].setAttribute("y", "-35px")
  }
