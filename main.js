...
//global vars
var pathContentPoint, sameScore, position, substring
//global arrays
var colors = new Array, points = new Array, names = new Array, pointsNames = new Array, capColors = new Array, backpackColors = new Array, bodyColors = new Array
//whole svg path
...
//players array
//["jméno", body, "barva kšiltovky", "barva batohu", "barva oblečení"]
var players = [["Michal", 1, red, lightRed, blue], ["Terka", 7, green, lightGreen, brown], ["Tomáš", 11, green, lightGreen, brown], ["Kika", 50, green, lightGreen, brown], ["Lukáš", 28, green, lightGreen, brown], ["Matěj", 46, green, lightGreen, brown], ["Jakub", 3, green, lightGreen, brown], ["Ema", 47, green, lightGreen, brown], ["Anna", 48, green, lightGreen, brown], ["Víťa", 45, green, lightGreen, brown], ["Kryštof", 12, green, lightGreen, brown], ["Bea", 20, green, lightGreen, brown], ["Aďa", 34, green, lightGreen, brown]]

//get score from array into another single array
for (var p in players) {
  names[p] = players[p][0]
  points[p] = players[p][1]
  capColors[p] = players[p][2]
  backpackColors[p] = players[p][3]
  bodyColors[p] = players[p][4]
