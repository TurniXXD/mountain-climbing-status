...
var clothes = document.getElementsByClassName('clothes'),
  clothes1 = document.getElementsByClassName('clothes-1')
var backpack = document.getElementsByClassName('backpack'),
  backpack1 = document.getElementsByClassName('backpack-1')
var cap = document.getElementsByClassName('cap'),
  cap1 = document.getElementsByClassName('cap-1')
var scoreboard1 = document.getElementById('scoreboard-1'),
  scoreboard2 = document.getElementById('scoreboard-2'),
  scoreboard3 = document.getElementById('scoreboard-3'),
  scoreboard4 = document.getElementById('scoreboard-4'),
  scoreboard5 = document.getElementById('scoreboard-5')
//colors
var red = 'DB0000',
  lightRed = 'FF5F7B',
  blue = '325DCA',
...
for (let i = 0; i < players.length; i++) {
  ...
  for (let s = 0; s < sameScore.length; s++) {
    if (JSON.stringify(players[i][0]) == JSON.stringify(sameScore[s])) players[i].push('sameScore')
  }
}
